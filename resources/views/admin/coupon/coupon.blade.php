                    ...
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        @foreach($coupon as $key => $row)
                            <tr>
                                ...
                                <td>{{ $row->discount }} %</td>
                                <td>
                                    <a href="{{ \Illuminate\Support\Facades\URL::to('edit/coupon/'.$row->id) }}" class="btn btn-sm btn-info">Edit</a>
                                    <a href="{{  \Illuminate\Support\Facades\URL::to('delete/coupon/'.$row->id) }}" class="btn btn-sm btn-danger" id="delete">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
