...
<div class="image_9"><img src="images/home/product2.jpg"></div>
<div class="col-xl-4 col-12" img src="images/img-5.png">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body pb-0">
                                     ...
                                     <div class="row">
                                                                   ...
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1"> main categories settings</a></div>

                                                                   <div class="row">
                                    <a href="{{route('admin.subcategories')}}"
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">sub_categories settings</a></div>
                                                                   <div class="row">
                                    <a href="{{route('admin.products')}}"
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">products settings</a></div>
                                                                  
                                                                   <div class="row">
                                    <a href="{{route('admin.invoices')}}"
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">invoices settings</a></div>
