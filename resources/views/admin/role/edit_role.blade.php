  ...
  <div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
      <div class="card pd-20 pd-sm-40">
        <h6 class="card-body-title">Edit Moderator</h6>
        <p class="mg-b-20 mg-sm-b-30">Edit Moderator Form</p>
