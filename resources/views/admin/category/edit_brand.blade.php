                    ...
                    <form action="{{url('update/brand/'.$brand->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-body pd-20">
                            <div class="mb-3">
                                ...
                                <div id="emailHelp" class="form-text">You can enter your new Brand here</div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <img src="{{\Illuminate\Support\Facades\URL::to($brand->brand_logo)}}" height="70px;" width="90px;">
