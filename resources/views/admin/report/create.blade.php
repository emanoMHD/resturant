                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">إضافة   تقرير
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> إضافة تقرير </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.reports.store')}}"
                                              method="POST"
                                            ...
                                            <label for="customer_name">vendor name</label>
                                            ...
                                            <div class="col-4">
                                            <div class="form-group">
                                            <label for="customer_email">vendor email</label>
