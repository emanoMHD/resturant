                ...
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('admin.reports')}}">التقارير </a>
                                </li>
                                <li class="breadcrumb-item active">تعديل تقرير
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <div class="content-body">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> تعديل تقرير </h4>
                ...
                @foreach($report->details as $item)
                                <tr class="cloning_row" id="{{ $loop->index }}">
                                    ...
                                    <td>
                                        <select name="unite[{{ $loop->index }}]" id="unite" class="unite form-control">
                                            <option></option>
...
$('#report_details').on('keyup blur','.quantity',function()
{
...
$('#report_details').on('keyup blur','.unite_price',function()
{
let $row=$(this).closest('tr');
let quantity=$row.find('.quantity').val() || 0;
let unit_price=$row.find('.unite_price').val() ||0;
...
$('#report_details').on('keyup blur','.discount_value',function()
{
...
$('#report_details').on('keyup blur','.discount_type',function()
{

$('#vat_value').val(calculate_vat());
$('#total_due').val(sum_due_total());
});
$('#report_details').on('keyup blur','.shipping',function()
{
...
let trcount=$('#report_details').find('tr.cloning_row:last').lengh;
let numinc=trcount>0?parseInt($('#report_details').find('tr.cloning_row:last').attr('id'))+1:0;
$('#report_details').find('tbody').append($(''+
