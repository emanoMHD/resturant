                ...
                <div class="table-wrapper">
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ \Illuminate\Support\Facades\URL::to('edit/blog/category/'.$row->id) }}" class="btn btn-sm btn-info">Edit</a>
                                <a href="{{  \Illuminate\Support\Facades\URL::to('delete/blog/category/'.$row->id) }}" class="btn btn-sm btn-danger" id="delete">Delete</a>
                            </td>
                        </tr>
                        @endforeach
                        </tbody>
                ...
                <div class="modal-content tx-size-sm">
                    ...
                    <form action="{{route('store.blog.category')}}" method="post">
                        ...
                        <div class="modal-body pd-20">
                            ...
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">اسم الصنف بالعربي</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                                placeholder="اسم الصنف بالعربي" name="category_name_ar">
                                <div id="emailHelp" class="form-text">يمكنك إدخال الصنف الجديد هنا</div>
                            </div>
