                ...
                <div class="table-wrapper">
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ \Illuminate\Support\Facades\URL::to('edit/post/'.$row->id) }}" class="btn btn-sm btn-info">Edit</a>
                                <a href="{{  \Illuminate\Support\Facades\URL::to('delete/post/'.$row->id) }}" class="btn btn-sm btn-danger" id="delete">Delete</a>
                            </td>
                        </tr>
                        @endforeach
                        </tbody>
