...
@else
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href="{{URL::to('admin/home')}}"><i class="icon ion-android-star-outline"></i>Resturant Mangment</a></div>
...
{{--            </a><!-- sl-menu-link -->--}}
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{route('categories')}}" class="nav-link">Main Category</a></li>
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{route('admin.invoices')}}" class="nav-link">All Invoices</a></li>
                <li class="nav-item"><a href="{{route('admin.invoices.create')}}" class="nav-link">Create Invoices</a></li>
            ...
            <ul class="sl-menu-sub nav flex-column">
                ...
                <li class="nav-item"><a href="{{route('admin.accept.payment')}}" class="nav-link">Accepted Orders</a></li>
                <li class="nav-item"><a href="{{route('admin.cancel.order')}}" class="nav-link">Cancelled Orders</a></li>
                <li class="nav-item"><a href="{{route('admin.process.payment')}}" class="nav-link">On Delivery</a></li>
                <li class="nav-item"><a href="{{route('admin.success.payment')}}" class="nav-link">Delivered</a></li>
            ...
            <a href="#" class="sl-menu-link">
                <div class="sl-menu-item">
                    ...
                    <span class="menu-item-label">Reports for orders</span>
                    <i class="menu-item-arrow fa fa-angle-down"></i>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('today.order') }}" class="nav-link">Today Orders</a></li>
                <li class="nav-item"><a href="{{ route('today.delivery') }}" class="nav-link">Today Deliveries</a></li>
                <li class="nav-item"><a href="{{ route('month.orders') }}" class="nav-link">Month Deliveries</a></li>
            ...
            <a href="#" class="sl-menu-link">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-ios-filing-outline tx-24"></i>
                    <span class="menu-item-label">Reports for vendors</span>
                    <i class="menu-item-arrow fa fa-angle-down"></i>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('admin.reports') }}" class="nav-link">Report Vendors</a></li>
                <li class="nav-item"><a href="{{ route('admin.reports.create') }}" class="nav-link"> Create Report</a></li>
            ...
            <ul class="sl-menu-sub nav flex-column">
                ...
                <li class="nav-item"><a href="{{ route('admin.all.requests') }}" class="nav-link">All Requests</a></li>
            </ul>
            @else 
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('admin.site.setting') }}" class="nav-link">Settings</a></li>
            </ul>
            @else 

            @endif

            @if(Auth::user()->other == 0)
            <a href="#" class="sl-menu-link">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-ios-filing-outline tx-24"></i>
            ...
            <nav class="nav">
                <div class="dropdown">
                    <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
                        ...
                        <img src="{{asset('backend/img/download.png')}}" class="wd-32 rounded-circle" alt="">
                    </a>
