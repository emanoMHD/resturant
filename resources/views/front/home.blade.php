                        ...
                        <div class="limit-box">
                           <nav class="main-menu">
                              <ul class="menu-area-main">
                                 ...
                                 <li><a href="{{route('front.testmonial')}}">Testmonial</a></li>
                                 <li><a href="{{route('front.clients')}}">Shop</a></li>
               ...
               <div class="carousel-item active">
                  <div class="container">
                     <div class="row marginii">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div class="img-box">
                              <figure><img src="images/img-1.png" alt="img"/></figure>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="carousel-item">
                  <div class="container">
                     <div class="row marginii">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div class="img-box ">
                              <figure><img src="images/girl2.jpg" alt="img"/></figure>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="carousel-item">
                  <div class="container">
                     <div class="row marginii">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div class="img-box">
                              <figure><img src="images/img-5.png" alt="img"/></figure>
                           </div>
                        </div>
                     </div>
                  </div>
         ...
         <div class="clothes_main section ">
          <div class="container">
            <div class="row">
               ...
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                  <div class="sport_product">
                     <figure><img src="images/img-7.png" alt="img"/"></figure>
                 
                  </div>
               </div>
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 ">
                  <div class="sport_product">
                     <figure><img src="images/img-3.png" alt="img"/"></figure>
                    
                  </div>
               </div>
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 ">
                  <div class="sport_product">
                     <figure><img src="images/img-6.png" alt="img"></figure>
               ...
               <div class="carousel-item active">
                  <div class="container">
                     <div class="row marginii">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div class="img-box">
                              <figure><img src="images/gallery4.jpg" style="max-width: 100%; border: 15px solid #fff;"/></figure>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="carousel-item">
                  <div class="container">
                     <div class="row marginii">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div class="img-box ">
                              <figure><img src="images/product12.jpg" style="max-width: 100%; border: 15px solid #fff;"/></figure>
                           </div>
                        </div>
                     </div>
                  </div>
