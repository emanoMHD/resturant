                                    ...
                                    class="header_search_form clearfix">
                                        ...
                                        <input type="search" required="required" class="header_search_input"
                                         ...
                                         <button type="submit" class="header_search_button trans_300" value="Submit">
                                            <img src="{{ asset('public/frontend/images/search.png')}}" alt="">
                                        </button>
                                    </form>
                                </div>
                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Order Status Code</h5>
                ...
                <form method="post" action="{{ route('order.tracking') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" name="code" required="" class="form-control" 
                            placeholder="Enter Your Order Status Code">
                    </div>
...
<script>
    $(document).on("click", "#return", function(e){
        ...
        swal({
            title: "Are you sure you Want to return order?",
            text: "money back not guaranteed!!",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        })
