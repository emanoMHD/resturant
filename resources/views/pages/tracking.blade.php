    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-5 offset-lg-1">
          ...
          @elseif($track->status == 1)
          <h4>Note : Payment method is being processed  </h4>

          @elseif($track->status == 2)
          <h4>Note : Packing Done En Route  </h4>
        ...
        <div class="col-5 offset-lg-1">
          ...
          <ul class="list-group col-lg-12">
            ...
            <!-- Every customer in Stripe Billing has a credit balance that you can issue credit and debit adjustments  
                 against. Adjustments in the credit balance could be a credit (meaning you owe them money) or a debit (meaning they owe you money). 
            -->
