                        ...
                        <div class="deals_slider_container">
                            ...
                            <div class="owl-carousel owl-theme deals_slider">
                                ...
                                <div class="owl-item deals_item">
                                    <div class="deals_image"><img src="{{ asset($ht->image_one)}}" alt="no image"></div>
                                            ...
                                            <div class="product_content">
                                                ...
                                                @else
                                                    <div class="product_price discount">${{$row->discount_price}}
                                                        <span>
                                                            <strike>${{$row->selling_price}}</strike>
                                                        </span>
                                                    </div>
                                                @endif
                                                ...
                                                <div class="product_name">
                                                    <div>
                                                        <a href="{{url(
                                                        'product/details/'.$row->id.'/'.$row->product_name)}}">
                                                            {{ $row->product_name}}
                                                        </a>
                                                    </div>
                                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <form method="post" action="{{ route('insert.into.cart' )}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" value="1" pattern="[0-9]" name="qty" min="1" oninput="validity.valid||(value='');">
