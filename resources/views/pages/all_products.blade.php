							...
							<div class="product_item is_new">
								<div class="product_border"></div>
									<div class="product_image d-flex flex-column align-items-center justify-content-center">
										<img src="{{ asset($pro->image_one) }}" alt="" style="height: 100px; width: 100px;">
									</div>
									<div class="product_content">
										...
										@else
											<div class="product_price discount">
												${{ $pro->discount_price }}<span> <strike> ${{ $pro->selling_price }} </strike></span>
											</div>
										@endif				

										<div class="product_name">
											<div>
												<a href="{{ url('product/details/'.$pro->id.'/'.$pro->product_name) }}" tabindex="0">
													{{ $pro->product_name  }} 
												</a>
											</div>
										</div>
									...
									<ul class="product_marks">
										@if($pro->discount_price == NULL)
											<li class="product_mark product_new" style="background: lightblue;">New</li>
										@else
											<li class="product_mark product_new" style="background: orangered;">
