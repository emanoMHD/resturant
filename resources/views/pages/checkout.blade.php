						...
						<div class="cart_items">
							<ul class="cart_list">
								...
								<li class="cart_item clearfix">
									<div class="cart_item_image text-center"><br><img src="{{asset($row->options->image)}}" 
										...
										<div class="cart_item_quantity cart_info_col">
											...
											<br><br>
												<form method="post" action="{{ route('update.cartitem') }}">
													...
													<input style="width: 50px;" type="number" value="{{$row->qty}}" pattern="[0-9]" name="qty" min="1" oninput="validity.valid||(value='');">
